    ...
    <main>
        <section class="portfolio-single fadeIn">   
            ...
            <div class="project-details container">
                ...
                <p>Some of the infrastructure was already there post-Woocommerce set-up, however the client requested certain custom features that were built-in by myself. The website hosts over 700 products and therefore considerable categorising and taxinomies were added to fit the needs of the client. The website also had to be secure to protect user data and handle payments which was taken care of via SSL Hosting and PayPal integration. More to the front-end, the client wanted Bootstrap galleries to showcase multiple images of their products, stock keeping unit (SKU) to be able to identify the product easier and repetitive navigations for their mature demographic.</p>

                <a class="portfolio-link" target="_blank" href="https://thehivehoneyshop.co.uk/product/propolis-herb-ointment-eczema-psoriasis/"><p>Go to Website →</p></a>
            </div>
        </section>
    </main>
